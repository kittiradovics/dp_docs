...
/**
 * Defines the translation handler for api_endpoint_sets.
 */
class APIEndpointSetTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Endpoint Set does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Endpoint Set does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIEndpointSetTranslationHandler::entityFormAlter().
   *
