...
/**
 * Defines the translation handler for api_docs.
 */
class APIDocTranslationHandler extends ContentTranslationHandler {
  ...
  protected function hasPublishedStatus() {
    // API Doc does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Doc does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIDocTranslationHandler::entityFormAlter().
   *
