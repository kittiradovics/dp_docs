...
/**
 * Defines the translation handler for api_schemas.
 */
class APISchemaTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Schema does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Schema does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APISchemaTranslationHandler::entityFormAlter().
   *
