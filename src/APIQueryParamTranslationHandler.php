...
/**
 * Defines the translation handler for api_query_params.
 */
class APIQueryParamTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Query Param does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Query Param does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIQueryParamTranslationHandler::entityFormAlter().
   *
