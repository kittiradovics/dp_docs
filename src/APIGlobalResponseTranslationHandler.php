...
/**
 * Defines the translation handler for api_global_responses.
 */
class APIGlobalResponseTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Global Response does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Global Response does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIGlobalResponseTranslationHandler::entityFormAlter().
   *
