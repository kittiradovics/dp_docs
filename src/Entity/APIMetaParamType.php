...
use Drupal\dp_docs\APIMetaParamTypeInterface;
 ...
 *   handlers = {
 *     "list_builder" = "Drupal\dp_docs\APIMetaParamTypeListBuilder",
 *     "form" = {
 *       "default" = "Drupal\dp_docs\APIMetaParamTypeForm",
 *       "add" = "Drupal\dp_docs\APIMetaParamTypeForm",
 *       "edit" = "Drupal\dp_docs\APIMetaParamTypeForm",
