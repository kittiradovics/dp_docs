 ...
 *   handlers = {
 *     "storage" = "Drupal\dp_docs\APIDocStorage",
 *     "list_builder" = "Drupal\dp_docs\APIDocListBuilder",
 *     "view_builder" = "Drupal\dp_docs\DPDocsContentEntityViewBuilder",
 *     "views_data" = "Drupal\dp_docs\APIDocViewsData",
 *     "form" = {
 *       "default" = "Drupal\dp_docs\APIDocForm",
 *       "add" = "Drupal\dp_docs\APIDocForm",
 *       "edit" = "Drupal\dp_docs\APIDocForm",
 *       "delete" = "Drupal\dp_docs\Form\DPDocsContentEntityDeleteForm",
 *     },
 *     "inline_form" = "Drupal\dp_docs\Form\DPDocsInlineForm",
 *     "route_provider" = {
 *       "html" = "Drupal\dp_docs\APIDocHtmlRouteProvider",
 *     },
 *     "access" = "Drupal\dp_docs\APIDocAccessControlHandler",
 *     "translation" = "Drupal\dp_docs\APIDocTranslationHandler",
 *   },
...
class APIDoc extends EditorialContentEntityBase implements APIDocInterface {
  ...
  */
  public function postSave(EntityStorageInterface $storage, $update = TRUE) {
    ...
    // api_doc table.
    if ($update) {
      dp_docs_reindex_api_doc_search($this->id());
    }
  }
  ...
  public function generateAutoLabel() {
    ...
    /** @var \Drupal\dp_docs\Entity\APIInfo $info */
