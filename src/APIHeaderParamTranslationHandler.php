...
/**
 * Defines the translation handler for api_header_params.
 */
class APIHeaderParamTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Header Param does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Header Param does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIHeaderParamTranslationHandler::entityFormAlter().
   *
