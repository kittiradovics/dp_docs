...
/**
 * Defines the translation handler for api_response_examples.
 */
class APIResponseExampleTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Response Example does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Response Example does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIResponseExampleTranslationHandler::entityFormAlter().
   *
