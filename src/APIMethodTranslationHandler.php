...
/**
 * Defines the translation handler for api_methods.
 */
class APIMethodTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Method does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Method does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIMethodTranslationHandler::entityFormAlter().
   *
