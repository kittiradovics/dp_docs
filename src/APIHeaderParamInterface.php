...
interface APIHeaderParamInterface extends ContentEntityInterface, EntityChangedInterface, RevisionLogInterface, AutoLabelInterface, MethodParameterInterface, ItemInterface, APIRefRefInterface, APIVersionTagRefInterface {
