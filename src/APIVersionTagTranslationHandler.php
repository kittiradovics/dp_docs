...
/**
 * Defines the translation handler for api_version_tags.
 */
class APIVersionTagTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Version Tag does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Version Tag does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIVersionTagTranslationHandler::entityFormAlter().
   *
