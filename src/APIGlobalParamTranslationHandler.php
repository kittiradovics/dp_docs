...
/**
 * Defines the translation handler for api_global_params.
 */
class APIGlobalParamTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Global Parameter does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Global Parameter does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIGlobalParamTranslationHandler::entityFormAlter().
   *
