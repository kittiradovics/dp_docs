...
/**
 * Defines the translation handler for api_refs.
 */
class APIRefTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Reference does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Reference does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIRefTranslationHandler::entityFormAlter().
   *
