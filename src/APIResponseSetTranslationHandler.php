...
/**
 * Defines the translation handler for api_response_sets.
 */
class APIResponseSetTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Response Set does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Response Set does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIResponseSetTranslationHandler::entityFormAlter().
   *
