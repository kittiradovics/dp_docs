...
/**
 * Defines the translation handler for api_params.
 */
class APIParamTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Parameter does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Parameter does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIParamTranslationHandler::entityFormAlter().
   *
