...
use Drupal\dp_docs\APIResponseStorageInterface;
...
class APIResponseController extends ControllerBase {
  ...
  public function revisionPageTitle($api_response_revision) {
    /** @var \Drupal\dp_docs\Entity\APIResponse $api_response */
    $api_response = $this->entityTypeManager()->getStorage('api_response')->loadRevision($api_response_revision);
   ...
   *
   * @param \Drupal\dp_docs\APIResponseInterface $api_response
  ...
  public function revisionOverview(APIResponseInterface $api_response) {
    ...
    /** @var \Drupal\dp_docs\APIResponseStorageInterface $api_response_storage */
    ...
    foreach ($this->getRevisionIds($api_response, $api_response_storage) as $vid) {
      /** @var \Drupal\dp_docs\APIResponseInterface $revision */
   ...
   * @param \Drupal\dp_docs\APIResponseStorageInterface $api_response_storage
