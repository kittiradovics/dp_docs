...
use Drupal\dp_docs\APIEndpointStorageInterface;
...
class APIEndpointController extends ControllerBase {
  ...
  public function revisionPageTitle($api_endpoint_revision) {
    /** @var \Drupal\dp_docs\Entity\APIEndpoint $api_endpoint */
    $api_endpoint = $this->entityTypeManager()->getStorage('api_endpoint')->loadRevision($api_endpoint_revision);
   ...
   *
   * @param \Drupal\dp_docs\APIEndpointInterface $api_endpoint
  ...
  public function revisionOverview(APIEndpointInterface $api_endpoint) {
    ...
    /** @var \Drupal\dp_docs\APIEndpointStorageInterface $api_endpoint_storage */
    ...
    foreach ($this->getRevisionIds($api_endpoint, $api_endpoint_storage) as $vid) {
      /** @var \Drupal\dp_docs\APIEndpointInterface $revision */
   ...
   * @param \Drupal\dp_docs\APIEndpointStorageInterface $api_endpoint_storage
