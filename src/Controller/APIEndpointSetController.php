...
use Drupal\dp_docs\APIEndpointSetStorageInterface;
...
class APIEndpointSetController extends ControllerBase {
  ...
  public function revisionPageTitle($api_endpoint_set_revision) {
    /** @var \Drupal\dp_docs\Entity\APIEndpointSet $api_endpoint_set */
    $api_endpoint_set = $this->entityTypeManager()->getStorage('api_endpoint_set')->loadRevision($api_endpoint_set_revision);
   ...
   *
   * @param \Drupal\dp_docs\APIEndpointSetInterface $api_endpoint_set
  ...
  public function revisionOverview(APIEndpointSetInterface $api_endpoint_set) {
    ...
    /** @var \Drupal\dp_docs\APIEndpointSetStorageInterface $api_endpoint_set_storage */
    ...
    foreach ($this->getRevisionIds($api_endpoint_set, $api_endpoint_set_storage) as $vid) {
      /** @var \Drupal\dp_docs\APIEndpointSetInterface $revision */
   ...
   * @param \Drupal\dp_docs\APIEndpointSetStorageInterface $api_endpoint_set_storage
