...
use Drupal\dp_docs\APIInfoStorageInterface;
...
class APIInfoController extends ControllerBase {
  ...
  public function revisionPageTitle($api_info_revision) {
    /** @var \Drupal\dp_docs\Entity\APIInfo $api_info */
    $api_info = $this->entityTypeManager()->getStorage('api_info')->loadRevision($api_info_revision);
   ...
   *
   * @param \Drupal\dp_docs\APIInfoInterface $api_info
   *   An API Info object.
   *
   * @return array
  ...
  public function revisionOverview(APIInfoInterface $api_info) {
    ...
    /** @var \Drupal\dp_docs\APIInfoStorageInterface $api_info_storage */
    ...
    foreach ($this->getRevisionIds($api_info, $api_info_storage) as $vid) {
      /** @var \Drupal\dp_docs\APIInfoInterface $revision */
   ...
   * @param \Drupal\dp_docs\APIInfoInterface $api_info
   *   The API Info entity.
   * @param \Drupal\dp_docs\APIInfoStorageInterface $api_info_storage
