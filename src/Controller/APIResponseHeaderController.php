...
use Drupal\dp_docs\APIResponseHeaderStorageInterface;
...
class APIResponseHeaderController extends ControllerBase {
  ...
  public function revisionPageTitle($api_response_header_revision) {
    /** @var \Drupal\dp_docs\Entity\APIResponseHeader $api_response_header */
    $api_response_header = $this->entityTypeManager()->getStorage('api_response_header')->loadRevision($api_response_header_revision);
   ...
   *
   * @param \Drupal\dp_docs\APIResponseHeaderInterface $api_response_header
  ...
  public function revisionOverview(APIResponseHeaderInterface $api_response_header) {
    ...
    /** @var \Drupal\dp_docs\APIResponseHeaderStorageInterface $api_response_header_storage */
    ...
    foreach ($this->getRevisionIds($api_response_header, $api_response_header_storage) as $vid) {
      /** @var \Drupal\dp_docs\APIResponseHeaderInterface $revision */
   ...
   * @param \Drupal\dp_docs\APIResponseHeaderStorageInterface $api_response_header_storage
