...
/**
 * Defines the translation handler for api_endpoints.
 */
class APIEndpointTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Endpoint does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Endpoint does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIEndpointTranslationHandler::entityFormAlter().
   *
