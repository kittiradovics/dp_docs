...
/**
 * Defines the translation handler for api_licenses.
 */
class APILicenseTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API License does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API License does not store creation date.
    return FALSE;
  }
