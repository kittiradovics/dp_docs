...
/**
 * Defines the translation handler for api_infos.
 */
class APIInfoTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Info does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Info does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIInfoTranslationHandler::entityFormAlter().
   *
