...
/**
 * Defines the translation handler for api_responses.
 */
class APIResponseTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Response does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Response does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIResponseTranslationHandler::entityFormAlter().
   *
