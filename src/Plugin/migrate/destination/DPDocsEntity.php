...
namespace Drupal\dp_docs\Plugin\migrate\destination;

use Drupal\dp_docs\Entity\APIVersionTag;
 ...
 * @MigrateDestination(
 *   id = "dp_docs_entity",
 *   deriver = "Drupal\dp_docs\Plugin\Derivative\DPDocsMigrateEntity"
 * )
 */
class DPDocsEntity extends EntityContentBase {

  /**
   * {@inheritdoc}
   */
  protected static function getEntityTypeId($plugin_id) {
    // Remove "dp_docs_entity:".
  ...
  protected function getEntity(Row $row, array $old_destination_id_values) {
    ...
    if (!empty($entity_id) && ($entity = $this->storage->load($entity_id))) {
      ...
      /** @var \Drupal\dp_docs\Entity\APIVersionTag $api_version_tag */
