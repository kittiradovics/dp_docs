...
namespace Drupal\dp_docs\Plugin\Search;
...
class APIDocSearch extends ConfigurableSearchPluginBase implements AccessibleInterface, SearchIndexingInterface {
  ...
  /**
   * Constructs a \Drupal\dp_docs\Plugin\Search\APIDocSearch object.
   *
  ...
  protected function prepareResults(StatementInterface $found) {
    ...
    foreach ($found as $item) {
      ...
      /** @var \Drupal\dp_docs\APIDocInterface $api_doc */
      ...
      /** @var \Drupal\dp_docs\APIDocTypeInterface $type*/
  ...
  public function searchFormAlter(array &$form, FormStateInterface $form_state) {
    ...
    $types = array_map(['\Drupal\Component\Utility\Html', 'escape'], dp_docs_api_doc_type_get_names());
