...
/**
 * Defines the translation handler for api_contacts.
 */
class APIContactTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Contact does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Contact does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIContactTranslationHandler::entityFormAlter().
   *
