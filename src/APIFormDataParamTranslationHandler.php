...
/**
 * Defines the translation handler for api_form_data_params.
 */
class APIFormDataParamTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Form Data Param does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Form Data Param does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIFormDataParamTranslationHandler::entityFormAlter().
   *
