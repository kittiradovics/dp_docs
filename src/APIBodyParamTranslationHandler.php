...
/**
 * Defines the translation handler for api_body_params.
 */
class APIBodyParamTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Body Param does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Body Param does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIBodyParamTranslationHandler::entityFormAlter().
   *
