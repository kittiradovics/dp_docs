...
/**
 * Defines the translation handler for api_tags.
 */
class APITagTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Tag does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Tag does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APITagTranslationHandler::entityFormAlter().
   *
