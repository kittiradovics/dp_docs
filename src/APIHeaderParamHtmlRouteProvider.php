...
class APIHeaderParamHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-page') && $entity_type->getKey('bundle')) {
      ...
      $route->setDefaults([
          '_controller' => '\Drupal\dp_docs\Controller\APIHeaderParamController::addPage',
    ...
    if ($entity_type->hasLinkTemplate('version-history')) {
      ...
      $route
        ->setDefaults([
          ...
          '_controller' => '\Drupal\dp_docs\Controller\APIHeaderParamController::revisionOverview',
        ])
  ...
  protected function getRevisionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision')) {
      ...
      $route
        ->setDefaults([
          '_controller' => '\Drupal\dp_docs\Controller\APIHeaderParamController::revisionShow',
          '_title_callback' => '\Drupal\dp_docs\Controller\APIHeaderParamController::revisionPageTitle',
        ])
        ->setRequirement('_permission', 'access api header param revisions')
        ->setOption('_admin_route', TRUE);
  ...
  protected function getRevisionRevertRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision_revert')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\dp_docs\Form\APIHeaderParamRevisionRevertForm',
  ...
  protected function getRevisionDeleteRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision_delete')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\dp_docs\Form\APIHeaderParamRevisionDeleteForm',
  ...
  protected function getRevisionTranslationRevertRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('translation_revert')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\dp_docs\Form\APIHeaderParamRevisionRevertTranslationForm',
  ...
  protected function getMultipleDeleteRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('multiple_delete_confirm')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\dp_docs\Form\DeleteMultipleAPIHeaderParams',
