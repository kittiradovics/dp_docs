...
/**
 * Defines the translation handler for api_ext_docs.
 */
class APIExtDocTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Ext Doc does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Ext Doc does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIExtDocTranslationHandler::entityFormAlter().
   *
