...
/**
 * Defines the translation handler for api_param_items.
 */
class APIParamItemTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Param Item does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Param Item does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIParamItemTranslationHandler::entityFormAlter().
   *
