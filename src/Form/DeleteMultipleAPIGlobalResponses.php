...
class DeleteMultipleAPIGlobalResponses extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIGlobalResponseStorageInterface
   */
  protected $storage;
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIGlobalResponseInterface[] $api_global_responses */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm') && !empty($this->apiGlobalResponseInfo)) {
      ...
      if ($total_count) {
        drupal_set_message($this->formatPlural($total_count, 'Deleted 1 API Global Response.', 'Deleted @count API Global Responses.'));
      }
