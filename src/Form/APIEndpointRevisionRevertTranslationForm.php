...
/**
 * Provides a form for reverting an API Endpoint revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIEndpointRevisionRevertTranslationForm extends APIEndpointRevisionRevertForm {
  ...
  /**
   * Constructs a new APIEndpointRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_endpoint_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_endpoint_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_endpoint_revision);
  ...
  protected function prepareRevertedRevision(APIEndpointInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIEndpointInterface $latest_revision */
    $latest_revision = $this->apiEndpointStorage->load($revision->id());
