...
/**
 * Provides a form for reverting an APIResponseHeader revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIResponseHeaderRevisionRevertTranslationForm extends APIResponseHeaderRevisionRevertForm {
  ...
  /**
   * Constructs a new APIResponseHeaderRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_response_header_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_response_header_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_response_header_revision);
  ...
  protected function prepareRevertedRevision(APIResponseHeaderInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIResponseHeaderInterface $latest_revision */
    $latest_revision = $this->apiResponseHeaderStorage->load($revision->id());
