...
class DeleteMultipleAPIEndpointSets extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIEndpointSetStorageInterface
   */
  protected $storage;
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIEndpointSetInterface[] $api_endpoint_sets */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm') && !empty($this->apiEndpointSetInfo)) {
      ...
      if ($total_count) {
        drupal_set_message($this->formatPlural($total_count, 'Deleted 1 API Endpoint Set.', 'Deleted @count API Endpoint Sets.'));
      }
