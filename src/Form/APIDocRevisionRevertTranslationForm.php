...
/**
 * Provides a form for reverting an APIDoc revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIDocRevisionRevertTranslationForm extends APIDocRevisionRevertForm {
  ...
  /**
   * Constructs a new APIDocRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_doc_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_doc_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_doc_revision);
  ...
  protected function prepareRevertedRevision(APIDocInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIDocInterface $latest_revision */
    $latest_revision = $this->apiDocStorage->load($revision->id());
