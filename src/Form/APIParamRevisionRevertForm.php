...
/**
 * Provides a form for reverting an APIParam revision.
 *
 * @ingroup dp_docs
 */
class APIParamRevisionRevertForm extends ConfirmFormBase {

  /**
   * The APIParam revision.
   *
   * @var \Drupal\dp_docs\APIParamInterface
   */
  protected $revision;
  ...
  /**
   * Constructs a new APIParamRevisionRevertForm.
   *
  ...
  public function getFormId() {
    return 'api_param_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('API Parameter: reverted %title revision %revision.', [
      '%title' => $this->revision->label(),
      '%revision' => $this->revision->getRevisionId(),
    ]);
    drupal_set_message($this->t('API Parameter %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\dp_docs\APIParamInterface $revision
