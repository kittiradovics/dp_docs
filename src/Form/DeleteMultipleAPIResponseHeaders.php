...
class DeleteMultipleAPIResponseHeaders extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIResponseHeaderStorageInterface
   */
  protected $storage;
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIResponseHeaderInterface[] $api_response_headers */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm') && !empty($this->apiResponseHeaderInfo)) {
      ...
      if ($total_count) {
        drupal_set_message($this->formatPlural($total_count, 'Deleted 1 API Response Header.', 'Deleted @count API Response Headers.'));
      }
