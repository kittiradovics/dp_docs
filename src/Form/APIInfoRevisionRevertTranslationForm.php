...
use Drupal\dp_docs\APIInfoInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a form for reverting an APIInfo revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIInfoRevisionRevertTranslationForm extends APIInfoRevisionRevertForm {
  ...
  /**
   * Constructs a new APIInfoRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_info_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_info_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_info_revision);
  ...
  protected function prepareRevertedRevision(APIInfoInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIInfoInterface $latest_revision */
    $latest_revision = $this->apiInfoStorage->load($revision->id());
