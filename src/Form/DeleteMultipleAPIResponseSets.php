...
class DeleteMultipleAPIResponseSets extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIResponseSetStorageInterface
   */
  protected $storage;
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIResponseSetInterface[] $api_response_sets */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm') && !empty($this->apiResponseSetInfo)) {
      ...
      if ($total_count) {
        drupal_set_message($this->formatPlural($total_count, 'Deleted 1 API Response Set.', 'Deleted @count API Response Sets.'));
      }
