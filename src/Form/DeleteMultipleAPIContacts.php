...
class DeleteMultipleAPIContacts extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIContactStorageInterface
   */
  protected $storage;
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIContactInterface[] $api_contacts */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm') && !empty($this->apiContactInfo)) {
      ...
      if ($total_count) {
        drupal_set_message($this->formatPlural($total_count, 'Deleted 1 API Contact.', 'Deleted @count API Contacts.'));
      }
