...
class APIGlobalParamRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIGlobalParamInterface
   */
  protected $revision;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('API Global Parameter %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\dp_docs\APIGlobalParamInterface $revision
