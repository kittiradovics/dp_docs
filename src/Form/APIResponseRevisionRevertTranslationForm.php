...
/**
 * Provides a form for reverting an APIResponse revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIResponseRevisionRevertTranslationForm extends APIResponseRevisionRevertForm {
  ...
  /**
   * Constructs a new APIResponseRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_response_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_response_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_response_revision);
  ...
  protected function prepareRevertedRevision(APIResponseInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIResponseInterface $latest_revision */
    $latest_revision = $this->apiResponseStorage->load($revision->id());
