...
/**
 * Provides a form for reverting an API Global Parameter revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIGlobalParamRevisionRevertTranslationForm extends APIGlobalParamRevisionRevertForm {
  ...
  /**
   * Constructs a new APIGlobalParamRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_global_param_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_global_param_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_global_param_revision);
  ...
  protected function prepareRevertedRevision(APIGlobalParamInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIGlobalParamInterface $latest_revision */
    $latest_revision = $this->apiGlobalParamStorage->load($revision->id());
