...
/**
 * Provides a form for reverting an APISchema revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APISchemaRevisionRevertTranslationForm extends APISchemaRevisionRevertForm {
  ...
  /**
   * Constructs a new APISchemaRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_schema_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_schema_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_schema_revision);
  ...
  protected function prepareRevertedRevision(APISchemaInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APISchemaInterface $latest_revision */
    $latest_revision = $this->apiSchemaStorage->load($revision->id());
