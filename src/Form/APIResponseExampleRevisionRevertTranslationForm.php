...
/**
 * Provides a form for reverting an APIResponseExample revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIResponseExampleRevisionRevertTranslationForm extends APIResponseExampleRevisionRevertForm {
  ...
  /**
   * Constructs a new APIResponseExampleRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_response_example_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_response_example_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_response_example_revision);
  ...
  protected function prepareRevertedRevision(APIResponseExampleInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIResponseExampleInterface $latest_revision */
    $latest_revision = $this->apiResponseExampleStorage->load($revision->id());
