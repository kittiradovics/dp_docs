...
class DeleteMultipleAPIResponses extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIResponseStorageInterface
   */
  protected $storage;
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIResponseInterface[] $api_responses */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm') && !empty($this->apiResponseInfo)) {
      ...
      if ($total_count) {
        drupal_set_message($this->formatPlural($total_count, 'Deleted 1 API Response.', 'Deleted @count API Responses.'));
      }
