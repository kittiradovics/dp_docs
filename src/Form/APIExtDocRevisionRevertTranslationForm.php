...
/**
 * Provides a form for reverting an APIExtDoc revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIExtDocRevisionRevertTranslationForm extends APIExtDocRevisionRevertForm {
  ...
  /**
   * Constructs a new APIExtDocRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_ext_doc_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_ext_doc_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_ext_doc_revision);
  ...
  protected function prepareRevertedRevision(APIExtDocInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIExtDocInterface $latest_revision */
    $latest_revision = $this->apiExtDocStorage->load($revision->id());
