...
/**
 * Provides a form for reverting an APIPathParam revision.
 *
 * @ingroup dp_docs
 */
class APIPathParamRevisionRevertForm extends ConfirmFormBase {

  /**
   * The APIPathParam revision.
   *
  ...
  /**
   * Constructs a new APIPathParamRevisionRevertForm.
   *
  ...
  public function getFormId() {
    return 'api_path_param_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('API HTTP Method Path Parameter: reverted %title revision %revision.', [
      '%title' => $this->revision->label(),
      '%revision' => $this->revision->getRevisionId(),
    ]);
    drupal_set_message($this->t('API HTTP Method Path Parameter %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\dp_docs\APIPathParamInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\dp_docs\APIPathParamInterface
