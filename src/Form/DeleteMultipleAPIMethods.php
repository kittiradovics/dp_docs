...
class DeleteMultipleAPIMethods extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIMethodStorageInterface
   */
  protected $storage;
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIMethodInterface[] $api_methods */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm') && !empty($this->apiMethodInfo)) {
      ...
      if ($total_count) {
        drupal_set_message($this->formatPlural($total_count, 'Deleted 1 API HTTP Method.', 'Deleted @count API HTTP Methods.'));
      }
