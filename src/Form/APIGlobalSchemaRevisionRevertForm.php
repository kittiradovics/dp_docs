...
/**
 * Provides a form for reverting an API Global Schema revision.
 *
 * @ingroup dp_docs
 */
class APIGlobalSchemaRevisionRevertForm extends ConfirmFormBase {

  /**
   * The API Global Schema revision.
   *
   * @var \Drupal\dp_docs\APIGlobalSchemaInterface
   */
  protected $revision;
  ...
  /**
   * Constructs a new APIGlobalSchemaRevisionRevertForm.
   *
  ...
  public function getFormId() {
    return 'api_global_schema_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('API Global Schema: reverted %title revision %revision.', [
      '%title' => $this->revision->label(),
      '%revision' => $this->revision->getRevisionId(),
    ]);
    drupal_set_message($this->t('API Global Schema %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\dp_docs\APIGlobalSchemaInterface $revision
