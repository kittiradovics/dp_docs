...
class DeleteMultipleAPIResponseExamples extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIResponseExampleStorageInterface
   */
  protected $storage;
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIResponseExampleInterface[] $api_response_examples */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm') && !empty($this->apiResponseExampleInfo)) {
      ...
      if ($total_count) {
        drupal_set_message($this->formatPlural($total_count, 'Deleted 1 API Response Example.', 'Deleted @count API Response Examples.'));
      }
