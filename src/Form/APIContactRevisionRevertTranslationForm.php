...
use Drupal\dp_docs\APIContactInterface;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides a form for reverting an API Contact revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIContactRevisionRevertTranslationForm extends APIContactRevisionRevertForm {
  ...
  /**
   * Constructs a new APIContactRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_contact_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_contact_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_contact_revision);
  ...
  protected function prepareRevertedRevision(APIContactInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIContactInterface $latest_revision */
    $latest_revision = $this->apiContactStorage->load($revision->id());
