...
/**
 * Provides a form for reverting an API Reference revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIRefRevisionRevertTranslationForm extends APIRefRevisionRevertForm {
  ...
  /**
   * Constructs a new APIRefRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_ref_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_ref_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_ref_revision);
  ...
  protected function prepareRevertedRevision(APIRefInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIRefInterface $latest_revision */
    $latest_revision = $this->apiRefStorage->load($revision->id());
