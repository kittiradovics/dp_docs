...
class APIExtDocRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIExtDocInterface
   */
  protected $revision;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('API External Documentation %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\dp_docs\APIExtDocInterface $revision
