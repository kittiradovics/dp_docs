...
/**
 * Provides a form for reverting an APIFormDataParam revision for a single translation.
 *
 * @ingroup dp_docs
 */
class APIFormDataParamRevisionRevertTranslationForm extends APIFormDataParamRevisionRevertForm {
  ...
  /**
   * Constructs a new APIFormDataParamRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'api_form_data_param_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $api_form_data_param_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $api_form_data_param_revision);
  ...
  protected function prepareRevertedRevision(APIFormDataParamInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIFormDataParamInterface $latest_revision */
    $latest_revision = $this->apiFormDataParamStorage->load($revision->id());
