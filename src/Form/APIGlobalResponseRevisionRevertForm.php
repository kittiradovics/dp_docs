...
/**
 * Provides a form for reverting an APIGlobalResponse revision.
 *
 * @ingroup dp_docs
 */
class APIGlobalResponseRevisionRevertForm extends ConfirmFormBase {

  /**
   * The APIGlobalResponse revision.
   *
  ...
  /**
   * Constructs a new APIGlobalResponseRevisionRevertForm.
   *
  ...
  public function getFormId() {
    return 'api_global_response_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('API Global Response: reverted %title revision %revision.', [
      '%title' => $this->revision->label(),
      '%revision' => $this->revision->getRevisionId(),
    ]);
    drupal_set_message($this->t('API Global Response %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\dp_docs\APIGlobalResponseInterface $revision
