...
class DeleteMultipleAPIGlobalParams extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\dp_docs\APIGlobalParamStorageInterface
   */
  protected $storage;
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\dp_docs\APIGlobalParamInterface[] $api_global_params */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm') && !empty($this->apiGlobalParamInfo)) {
      ...
      if ($total_count) {
        drupal_set_message($this->formatPlural($total_count, 'Deleted 1 API Global Parameter.', 'Deleted @count API Global Parameters.'));
      }
