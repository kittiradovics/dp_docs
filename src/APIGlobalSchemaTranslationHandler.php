...
/**
 * Defines the translation handler for api_global_schemas.
 */
class APIGlobalSchemaTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  protected function hasPublishedStatus() {
    // API Global Schema does not have a status.
    return FALSE;
  }
  ...
  protected function hasCreatedTime() {
    // API Global Schema does not store creation date.
    return FALSE;
  }
  ...
  /**
   * Form submission handler for APIGlobalSchemaTranslationHandler::entityFormAlter().
   *
